...
class RunViewModel : ViewModel() {
            ...
            database.reference.child("users").child(auth?.currentUser?.uid!!)
                .addValueEventListener(object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        FirebaseService.cal =(timeSeconds/1000)*kg
                        ...
                        userRef.child(auth?.currentUser?.uid!!).child("data").setValue(Walk(time,distance,
                            age,step,
                            cal,
                            top
                        ))

                        _userWalk.postValue(Walk(time,distance,
                            age,
                            step,
                            cal,
                            top
    ...
    fun getWalkAvg(sex:String){
        ...
        myRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(userSnapshot: DataSnapshot) {
                ...
                if (step < step10) {
                    FirebaseService.age = 10
                    FirebaseService.top = ((10000/step10)*100)
                } else if (step > step10 && step < step20
                ) {
                    FirebaseService.age = if(step < (step10+step20)/2){
                        10
                    }else{
                        20
                    }
                    ...
                    FirebaseService.age = if(step < (step20+step30)/2){
                        20
                    }else{
                        30
                    }
                    ...
                    FirebaseService.age = if(step < (step30+step40)/2){
                        30
                    }else{
                        40
                    }
                    ...
                    FirebaseService.age = if(step < (step40+step50)/2){
                        40
                    }else{
                        50
                    }
                    ...
                    FirebaseService.age = if(step < (step50+step60)/2){
                        50
                    }else{
                        60
                    }
                    ...
                    FirebaseService.age = if(step < (step60+step70)/2){
                        60
                    }else{
                        70
                    }
    ...
    fun requestSetView(){
        viewModelScope.launch {
            _userWalk.postValue(FirebaseService.setView())
        }
    }

    fun requestSetUserWalk(walk:Walk){
        viewModelScope.launch(Dispatchers.IO) {
            FirebaseService.setUserWalk(walk)
        }
    }
}